...
# Load the data
pdb_data_p1 <- read.table('/home/axelle/Dropbox/draftAM1.0/Full_submission_Elife/Scripts/scripts_for_interface_conservation/Data/data_fig_s6A.tsv',
                          h = T, sep = '\t')
# Plot
p1 <- pdb_data_p1 %>%
...
# Load the data
pdb_data_p2 <- read.table('/home/axelle/Dropbox/draftAM1.0/Full_submission_Elife/Scripts/scripts_for_interface_conservation/Data/data_fig_s6B.tsv',
                          h = T, sep = '\t')
...
p_int_conservation
ggsave(filename = '/home/axelle/Dropbox/draftAM1.0/Full_submission_Elife/Scripts/scripts_for_interface_conservation/FigureS6.pdf',
