...
#### Format the table of PDB matches (old) ####

final_PDB_matches <- read.table('~/Documents/Hiver2019/Paper_duplication/Submission_eLife_AC/Data/Interface_conservation/003_data_tables/paralogs_PDB_structures.txt',
                                h = T, sep = '\t')
...
write.table(x = final_PDB_matches, quote = F, sep = '\t', row.names = F, col.names = T, 
            file = '~/Documents/Hiver2019/Paper_duplication/Submission_eLife_AC/Data/Interface_conservation/003_data_tables/paralogs_PDB_structures_reformatted.txt')

#### Let's do the same reformatting for the matrix that has strict HMs ####
final_PDB_matches <- read.table('~/Documents/Hiver2019/Paper_duplication/Submission_eLife_AC/Data/Interface_conservation/003_data_tables/paralogs_PDB_structures_with_strict.txt',
                                h = T, sep = '\t')
...
write.table(x = struct_one_monomer_oneHM, file = '~/Documents/Hiver2019/Paper_duplication/Submission_eLife_AC/Data/Interface_conservation/003_data_tables/paralogs_PDB_structures_one_monomer_one_HM.txt',
...
# Let's just write the complete table with this format
write.table(x = final_PDB_matches, quote = F, sep = '\t', row.names = F, col.names = T, 
            file = '~/Documents/Hiver2019/Paper_duplication/Submission_eLife_AC/Data/Interface_conservation/003_data_tables/paralogs_PDB_structures_reformatted_with_strict.txt')
